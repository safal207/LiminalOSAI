...
INTROSPECT_SRCS := src/introspect.c src/dream_coupler.c
SUBSTRATE_SRCS := core/liminal_substrate.c empathic/field.c memory/emotion_memory.c council/inner.c $(AFFINITY_SRCS) $(ANTICIPATION_SRCS)
