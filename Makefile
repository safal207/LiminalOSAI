...
SUBSTRATE_SRCS := core/liminal_substrate.c core/trs_filter.c core/trs_adapt.c core/erb.c core/astro_sync.c core/dream_replay.c core/synaptic_bridge.c empathic/field.c memory/emotion_memory.c council/inner.c $(AFFINITY_SRCS) $(ANTICIPATION_SRCS)
