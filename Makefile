...
CORE_SRCS   := core/pulse_kernel.c core/trs_filter.c core/trs_adapt.c core/erb.c core/astro_sync.c core/neural_resonance.c
...
SUBSTRATE_SRCS := core/liminal_substrate.c core/trs_filter.c core/trs_adapt.c core/erb.c core/astro_sync.c core/dream_replay.c core/synaptic_bridge.c core/kiss_cascade.c empathic/field.c memory/emotion_memory.c memory/soil.c bus/resonant.c council/inner.c coherence/field.c awareness/bridge.c $(AFFINITY_SRCS) $(ANTICIPATION_SRCS)
...
COLLECTIVE_SRCS := collective/graph.c collective/memory.c collective/bodhicitta.c
