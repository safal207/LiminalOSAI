...
CORE_SRCS   := core/pulse_kernel.c core/trs_filter.c core/trs_adapt.c core/erb.c
...
SUBSTRATE_SRCS := core/liminal_substrate.c core/trs_filter.c core/trs_adapt.c core/erb.c empathic/field.c memory/emotion_memory.c council/inner.c $(AFFINITY_SRCS) $(ANTICIPATION_SRCS)
...
SUBSTRATE_SRCS += $(MIRROR_SRCS) $(COLLECTIVE_SRCS) $(INTROSPECT_SRCS)
SRCS        := $(CORE_SRCS) $(AFFINITY_SRCS) $(ANTICIPATION_SRCS) $(INTROSPECT_SRCS) $(MEM_SRCS) $(BUS_SRCS) $(SYM_SRCS) $(REF_SRCS) $(AWARE_SRCS) $(COUNCIL_SRCS) $(COH_SRCS) $(COLLECTIVE_SRCS) $(DIAG_SRCS) $(SYNC_SRCS) $(DREAM_SRCS) $(METAB_SRCS) $(SYMBIOTIC_SRCS) $(EMPATHIC_SRCS) $(MIRROR_SRCS)
OBJS        := $(SRCS:.c=.o)
