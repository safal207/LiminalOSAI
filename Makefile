...
test: $(TARGET)
	...
	@python3 -m unittest tests/test_liminal_evidence_advisor.py tests/test_chatgpt_liminal_adapter.py tests/test_chatgpt_conversation_normalizer.py tests/test_chatgpt_live_session_exporter.py tests/test_trace_visualizer.py tests/test_pulse_kernel_cli.py -v
